...
function updateResultPage() {
    ...
    // 更新复杂度提示 - 移除"建议进一步评估"作为标题
    let complexityTitle = currentResults.complexity;
    if (complexityTitle === "建议进一步评估") {
        complexityTitle = "复杂度提示";
    }
    resultComplexity.textContent = complexityTitle;
